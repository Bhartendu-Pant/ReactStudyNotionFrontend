...
function SignupForm({ setIsLoggedIn }) {
    ...
    return (
        <div className='w-11/12 max-w-[450px] '>
            ...
            <div className='flex bg-richblack-800 p-1 gap-x-1 my-6 max-w-max rounded-full border-b-2 border-gray-500 '>
            ...
            <form onSubmit={submitHandler}>
                ...
                <div className='flex gap-x-4'>
                    <label className='w-full'>
                        ...
                        <input
                            className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[10px]  border-b-2 border-gray-500 outline-blue-400'
                ...
                <button className='bg-yellow-500 rounded-[8px] w-full font-medium text-richblack-900 px-[12px] py-[8px] mt-6'>
                    Create Account
                </button>
            </form>
